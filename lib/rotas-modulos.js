...
async function handleModulos(ctx) {
  ...
  function seedThreadMensagens(slug, contato) {
    ...
    const scripts = {
      ...
      obras: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Equipe de Obras no painel.', criadoEm: horasAtras(4.6) },
        { de: 'gabinete', autor: gab, texto: 'Marcos, aquele buraco lá da Djalma — vi aqui que não chegou ninguém. O que houve?', criadoEm: horasAtras(4.5) },
        { de: 'secretaria', autor: c, texto: 'Senhor, a equipe ia pela manhã, mas o caminhão de brita atrasou na base.', criadoEm: horasAtras(4.4) },
        { de: 'secretaria', autor: c, texto: 'Já realoquei: a EQ-OBR-01 sai agora para a Djalma. Chegada prevista em cerca de 40 minutos.', criadoEm: horasAtras(4.35) },
        { de: 'gabinete', autor: gab, texto: 'Quero foto do antes e do depois. Me confirma quando chegar no local.', criadoEm: horasAtras(4.2) },
        { de: 'secretaria', autor: c, texto: 'Combinado. Assim que a equipe fizer check-in na Djalma eu aviso por aqui e mando a foto.', criadoEm: horasAtras(4.1) },
        { de: 'gabinete', autor: gab, texto: 'E o prazo para tapar?', criadoEm: horasAtras(3.9) },
        { de: 'secretaria', autor: c, texto: 'Com material no local, conclusão ainda hoje até no máximo 16h. Qualquer imprevisto eu te falo na hora.', criadoEm: horasAtras(3.8) },
      ],
      iluminacao: [
