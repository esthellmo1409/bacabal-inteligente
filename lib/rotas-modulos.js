...
async function handleModulos(ctx) {
  ...
  const CHAT_SEED_VERSION = 2;

  function horasAtras(h) {
    return new Date(Date.now() - h * 3600 * 1000).toISOString();
  }

  function seedThreadMensagens(slug, contato) {
    const gab = (slug === 'bomlugar') ? 'Gabinete da Prefeita' : 'Gabinete do Prefeito';
    const c = contato.nome;
    const scripts = {
      saude: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Estou no painel da Saúde — plantão, fila e escala das unidades.', criadoEm: horasAtras(5.2) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia, Ana. Como está a cobertura de plantão hoje?', criadoEm: horasAtras(5.1) },
        { de: 'secretaria', autor: c, texto: 'Hospital e UBS Centro confirmados. UBS São José ainda sem confirmação no turno da manhã.', criadoEm: horasAtras(5.0) },
        { de: 'gabinete', autor: gab, texto: 'E a fila do Hospital?', criadoEm: horasAtras(4.8) },
        { de: 'secretaria', autor: c, texto: 'Fila elevada e espera acima da meta. Já pedi reforço na escala da tarde.', criadoEm: horasAtras(4.7) },
        { de: 'gabinete', autor: gab, texto: 'Me avise se o plantão da UBS São José confirmar até o meio-dia.', criadoEm: horasAtras(4.5) },
        { de: 'secretaria', autor: c, texto: 'Combinado. Qualquer alteração eu mando por aqui.', criadoEm: horasAtras(4.4) },
      ],
      obras: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Equipe de Obras online — buracos, pavimentação e galerias.', criadoEm: horasAtras(4.5) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia, Marcos. Tem obra crítica parada?', criadoEm: horasAtras(4.4) },
        { de: 'secretaria', autor: c, texto: 'Temos 3 buracos prioritários no Centro e São José. Equipe já saiu com material.', criadoEm: horasAtras(4.3) },
        { de: 'gabinete', autor: gab, texto: 'Preciso de prazo para a Rua Principal.', criadoEm: horasAtras(4.1) },
        { de: 'secretaria', autor: c, texto: 'Previsão: concluir ainda hoje até 17h. Te atualizo com foto do depois.', criadoEm: horasAtras(4.0) },
      ],
      iluminacao: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Iluminação no painel — postes e lâmpadas.', criadoEm: horasAtras(3.8) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia. Quantos postes apagados estão abertos?', criadoEm: horasAtras(3.7) },
        { de: 'secretaria', autor: c, texto: '12 abertos. Priorizei a avenida principal e a praça. Caminhão sobe às 14h.', criadoEm: horasAtras(3.6) },
        { de: 'gabinete', autor: gab, texto: 'Ok. Me confirma quando a praça estiver 100%.', criadoEm: horasAtras(3.4) },
        { de: 'secretaria', autor: c, texto: 'Confirmado. Assim que finalizar eu aviso por aqui.', criadoEm: horasAtras(3.3) },
      ],
      limpeza: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Limpeza Urbana online — coleta e varrição.', criadoEm: horasAtras(3.2) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia, José. Tem ponto de lixo acumulado?', criadoEm: horasAtras(3.1) },
        { de: 'secretaria', autor: c, texto: 'Sim, dois pontos no bairro São José. Caminhão já foi liberado.', criadoEm: horasAtras(3.0) },
        { de: 'gabinete', autor: gab, texto: 'Priorize antes do horário de pico.', criadoEm: horasAtras(2.8) },
        { de: 'secretaria', autor: c, texto: 'Combinado. Retorno com status até 15h.', criadoEm: horasAtras(2.7) },
      ],
      meio_ambiente: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Meio Ambiente no painel — poda e área verde.', criadoEm: horasAtras(2.6) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia. Tem árvore com risco?', criadoEm: horasAtras(2.5) },
        { de: 'secretaria', autor: c, texto: 'Uma no Centro com galho rachado. Equipe de poda agenda para amanhã cedo.', criadoEm: horasAtras(2.4) },
        { de: 'gabinete', autor: gab, texto: 'Se for risco alto, antecipa para hoje.', criadoEm: horasAtras(2.2) },
        { de: 'secretaria', autor: c, texto: 'Vou realocar a equipe e te confirmo o horário.', criadoEm: horasAtras(2.1) },
      ],
      transito: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Trânsito online — sinalização e fluxo.', criadoEm: horasAtras(2.0) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia. Semáforo da avenida está ok?', criadoEm: horasAtras(1.9) },
        { de: 'secretaria', autor: c, texto: 'Houve falha ontem à noite; técnico já restabeleceu. Monitorando de manhã.', criadoEm: horasAtras(1.8) },
        { de: 'gabinete', autor: gab, texto: 'Bom. Qualquer recidiva me avisa na hora.', criadoEm: horasAtras(1.6) },
        { de: 'secretaria', autor: c, texto: 'Pode deixar. Estou de olho no painel.', criadoEm: horasAtras(1.5) },
      ],
      defesa_civil: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Defesa Civil no painel — ocorrências críticas.', criadoEm: horasAtras(1.4) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia. Tem alagamento ou esgoto estourado?', criadoEm: horasAtras(1.3) },
        { de: 'secretaria', autor: c, texto: 'Um ponto de esgoto no bairro baixo. Equipe em deslocamento.', criadoEm: horasAtras(1.2) },
        { de: 'gabinete', autor: gab, texto: 'Acompanhe e me diga se precisa apoio de outra secretaria.', criadoEm: horasAtras(1.0) },
        { de: 'secretaria', autor: c, texto: 'Se precisar de Obras eu aciono e te atualizo.', criadoEm: horasAtras(0.9) },
      ],
      ouvidoria: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Ouvidoria online — demandas gerais do cidadão.', criadoEm: horasAtras(0.8) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia. Tem reclamação recorrente hoje?', criadoEm: horasAtras(0.7) },
        { de: 'secretaria', autor: c, texto: 'Sim: demora em retorno de protocolos. Já cobrei as secretarias envolvidas.', criadoEm: horasAtras(0.6) },
        { de: 'gabinete', autor: gab, texto: 'Quero resumo até o fim da tarde.', criadoEm: horasAtras(0.4) },
        { de: 'secretaria', autor: c, texto: 'Envio o consolidado por aqui às 17h.', criadoEm: horasAtras(0.3) },
      ],
      eventos: [
        { de: 'secretaria', autor: c, texto: 'Bom dia. Cultura e Eventos no painel — agenda e estrutura.', criadoEm: horasAtras(0.85) },
        { de: 'gabinete', autor: gab, texto: 'Bom dia, Luísa. O evento do fim de semana está fechado?', criadoEm: horasAtras(0.75) },
        { de: 'secretaria', autor: c, texto: 'Estrutura e som ok. Falta confirmar limpeza pós-evento com a Limpeza Urbana.', criadoEm: horasAtras(0.65) },
        { de: 'gabinete', autor: gab, texto: 'Alinha com José e me confirma segurança também.', criadoEm: horasAtras(0.45) },
        { de: 'secretaria', autor: c, texto: 'Já chamei Limpeza e Segurança. Te confirmo até amanhã de manhã.', criadoEm: horasAtras(0.35) },
      ],
    };
    return (scripts[contato.id] || [
      { de: 'secretaria', autor: c, texto: `Bom dia. Estou online no painel da ${contato.cargo}.`, criadoEm: horasAtras(1) },
    ]).map((m, i) => ({ id: `MSG-${contato.id}-seed-${i}`, ...m }));
  }

  function respostaFluxoChat(secretaria, texto, gabineteNome) {
    const t = String(texto || '').toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '');
    const contato = CONTATOS_GABINETE[secretaria];
    const nome = contato?.nome?.split(' ')[0] || 'Equipe';
    const hora = new Date().getHours();
    const saudacaoVolta = hora < 12 ? 'Bom dia' : hora < 18 ? 'Boa tarde' : 'Boa noite';

    if (/\bbom dia\b/.test(t) || /\bboa tarde\b/.test(t) || /\bboa noite\b/.test(t) || /\bol[aá]\b/.test(t) || /\btudo bem\b/.test(t)) {
      const porSec = {
        saude: [
          `${saudacaoVolta}! Tudo bem. Estou no painel da Saúde.`,
          'Plantão e filas atualizados. Quer que eu foque em alguma unidade agora?',
        ],
        obras: [
          `${saudacaoVolta}! Equipe de Obras online.`,
          'Posso te passar o status dos buracos prioritários ou de alguma obra específica.',
        ],
        iluminacao: [
          `${saudacaoVolta}! Iluminação no painel.`,
          'Quer o resumo dos postes apagados ou prioridade de algum bairro?',
        ],
        limpeza: [
          `${saudacaoVolta}! Limpeza Urbana à disposição.`,
          'Posso checar coleta, varrição ou ponto de acúmulo — me diga o bairro.',
        ],
        meio_ambiente: [
          `${saudacaoVolta}! Meio Ambiente online.`,
          'Quer falar de poda, árvore com risco ou limpeza de área verde?',
        ],
        transito: [
          `${saudacaoVolta}! Trânsito no painel.`,
          'Posso atualizar sinalização, semáforo ou fluxo — o que prefere?',
        ],
        defesa_civil: [
          `${saudacaoVolta}! Defesa Civil online.`,
          'Tem ocorrência crítica para eu priorizar ou quer o panorama geral?',
        ],
        ouvidoria: [
          `${saudacaoVolta}! Ouvidoria à disposição.`,
          'Posso trazer as reclamações em aberto ou cobrar alguma secretaria específica.',
        ],
        eventos: [
          `${saudacaoVolta}! Cultura e Eventos no painel.`,
          'Quer status de agenda, estrutura, som ou limpeza pós-evento?',
        ],
      };
      return porSec[secretaria] || [`${saudacaoVolta}! Estou no painel.`, 'Pode mandar a observação que eu retorno.'];
    }

    if (/plant[aã]o|medico|m[eé]dico|ubs|hospital|fila|escala/.test(t) && secretaria === 'saude') {
      return [
        'Já estou conferindo plantão, escala e fila das unidades.',
        'Te retorno em instantes com o que estiver crítico.',
      ];
    }
    if (/buraco|obra|paviment|asfalto|prazo/.test(t) && secretaria === 'obras') {
      return [
        'Vou alinhar com a equipe de campo e te passo prazo.',
        'Assim que tiver foto do andamento eu mando por aqui.',
      ];
    }
    if (/poste|luz|lampada|lâmpada|apagad/.test(t) && secretaria === 'iluminacao') {
      return ['Já estou na fila de iluminação.', 'Priorizo o ponto que você citar e te confirmo.'];
    }
    if (/lixo|limpeza|varri|coleta/.test(t) && secretaria === 'limpeza') {
      return ['Entendido. Liberando equipe de limpeza.', 'Te atualizo quando o ponto estiver resolvido.'];
    }
    if (/evento|estrutura|som|palco/.test(t) && secretaria === 'eventos') {
      return ['Já estou na agenda e estrutura.', 'Confirmo os pendentes e te retorno.'];
    }
    if (/cobra|urgente|agora|na hora|priorid/.test(t)) {
      return [
        `Recebido, ${gabineteNome.includes('Prefeita') ? 'senhora' : 'senhor'}. Vou tratar como prioridade.`,
        'Te atualizo por aqui assim que avançar.',
      ];
    }
    if (/obrigad|valeu|ok|combinado|perfeito/.test(t)) {
      return [`Por nada. Qualquer coisa, ${nome} segue no painel.`];
    }

    const fallback = {
      saude: 'Recebido. Já estou no painel conferindo plantão, fila e alertas das unidades.',
      obras: 'Certo. Vou alinhar com a equipe de campo e te retorno com prazo.',
      iluminacao: 'Ok. Já estou verificando os postes e a fila da iluminação.',
      limpeza: 'Entendido. Vou priorizar a equipe de limpeza agora.',
      meio_ambiente: 'Recebido. Já estou olhando as ocorrências de poda e área verde.',
      transito: 'Certo. Vou checar sinalização e trânsito e te atualizo.',
      defesa_civil: 'Ok. Já estou acompanhando as ocorrências críticas da Defesa Civil.',
      ouvidoria: 'Recebido. Vou tratar e te dar retorno pelo painel.',
      eventos: 'Certo. Já estou na agenda e estrutura do evento.',
    };
    return [fallback[secretaria] || 'Recebido. Já estou olhando no painel e te retorno.'];
  }
  ...
  if (pathname === '/api/gabinete/chat' && req.method === 'POST') {
    ...
    // Fluxo de conversa (saudação / tema da secretaria) — base até chat ao vivo
    if (de === 'gabinete' && body.autoAck !== false) {
      ...
      respostas.forEach((linha, i) => {
        thread.mensagens.push({
          ...
          autor: contato.nome,
          texto: linha,
          criadoEm: new Date(Date.now() + 600 + i * 700).toISOString(),
          fluxo: true,
        });
      });
    }
